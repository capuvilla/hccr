  ...
  <q-page style="background: #E5E5E5">
    ...
    <div class="flex justify-center items-center">
      <div class="flex justify-center full-width container-text">
        Nos conte mais sobre a sua experiência
      </div>
      <q-option-group
        :options="options"
        label="Notifications"
    ...
    <div class="full-width">
      <div class="flex justify-center container-button full-width">
        <q-btn
          ...
          rounded
          color='deep-orange'
          label='ENVIE SUA AVALIAÇÃO'
          type='submit'
          style="width: 50%; letter-spacing: 1.25px; font-size: 14px; line-height: 16px; font-weight: 600;"
        />
      </div>
    </div>
  </q-page>
  ...
  data () {
    return {
      ...
      options: [
        ...
        { label: 'Rodovia mal iluminadas', value: 'postos', color: 'deep-orange' },
